...
@Component({
  selector: 'app-table-ceindicators',
  templateUrl: './table-ceindicators.component.html',
  styleUrls: ['./table-ceindicators.component.scss']
})
export class TableCEIndicatorsComponent implements OnInit {
  ...
  visualizaEditarUsuCentralAutorizador(element: any): boolean {
    ...
    if (this.revIns) // si es revision institucional no se muestra
    {
      return false;
    }
