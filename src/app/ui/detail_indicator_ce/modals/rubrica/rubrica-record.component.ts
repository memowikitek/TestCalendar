...
//    this.edit = true;
 //   this.title = ModalTitle.NEW;
  ...
  ngOnInit(): void {
    ...
    const rubrica: CeRubricasDTOV1 = new CeRubricasDTOV1().deserialize(tmp);
    ...
    if (this.rubricaData != null){
      ...
      let datos = new CeRubricasDTOV1().deserialize(this.rubricaData.dataSave);
  ...
  submit(): void {
    ...
    const tmp = this.RubricaRecordForm.getRawValue();    
    const idUser = JSON.parse(localStorage.getItem('session'));
    let rubrica: CeRubricasDTOV1 = new CeRubricasDTOV1().deserialize(tmp);      
    ...
    rubrica.indicadorId = indicadorInfo.indicadorId;
    rubrica.cicloEvaluacionId = indicadorInfo.cicloEvaluacionId;
...
//      rubrica.rubricaEvaluacionId = datos.rubricaEvaluacionId;        
      rubrica.rubricaEvaluacionId = datos.rubricaEvaluacionId;
      rubrica.indicadorId = datos.indicadorId;
      rubrica.cicloEvaluacionId = datos.cicloEvaluacionId;
      ...
      this.detailsIndicator.getCeRubricaUpdate(rubrica).subscribe(() => {
    ...
    } else 
    {
      ...
      this.detailsIndicator.addCeRubrica(rubrica).subscribe(() => {
